/* PrismJS 1.24.1
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+scss&plugins=line-highlight+show-language+keep-markup+normalize-whitespace+toolbar+copy-to-clipboard+treeview */
...
(function () {
	...
	function applyHash() {
		...
		if (scrollIntoView) {
			document.querySelector('.temporary.line-highlight').scrollIntoView('smooth');
		}
	}
...
(function () {
	...
	function copyTextToClipboard(copyInfo) {
		if (navigator.clipboard) {
			...
			navigator.clipboard.writeText(copyInfo.getText().trim()).then(copyInfo.success, function () {
